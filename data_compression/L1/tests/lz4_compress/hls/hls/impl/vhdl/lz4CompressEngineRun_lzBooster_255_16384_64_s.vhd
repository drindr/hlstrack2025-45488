...
attribute shreg_extract : string;
    ...
    signal icmp_ln559_reg_182 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln617_fu_154_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln559_fu_116_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out_ap_vld : STD_LOGIC;
    signal grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal i_2_fu_74 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
...
begin
    ...
    port map (
        ...
        sub => sub_reg_193,
        outValue_04_out => grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out,
        outValue_04_out_ap_vld => grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out_ap_vld);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_boolean_0 = ap_block_state5) and (ap_const_logic_1 = ap_CS_fsm_state5) and ((icmp_ln617_fu_154_p2 = ap_const_lv1_1) or (icmp_ln559_reg_182 = ap_const_lv1_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (icmp_ln559_fu_116_p2 = ap_const_lv1_0))) then 
                i_2_fu_74 <= ap_const_lv7_0;
            elsif (((ap_const_boolean_0 = ap_block_state5) and (icmp_ln617_fu_154_p2 = ap_const_lv1_0) and (icmp_ln559_reg_182 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                i_2_fu_74 <= i_6_fu_160_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                icmp_ln559_reg_182 <= icmp_ln559_fu_116_p2;
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, boosterStream_full_n, ap_CS_fsm_state5, icmp_ln559_reg_182, icmp_ln617_fu_154_p2, ap_CS_fsm_state4, ap_block_state1, icmp_ln559_fu_116_p2, grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_ap_done, ap_CS_fsm_state3, ap_block_state5)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (icmp_ln559_fu_116_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                elsif (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (icmp_ln559_fu_116_p2 = ap_const_lv1_0))) then
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_const_boolean_0 = ap_block_state5) and (ap_const_logic_1 = ap_CS_fsm_state5) and ((icmp_ln617_fu_154_p2 = ap_const_lv1_1) or (icmp_ln559_reg_182 = ap_const_lv1_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif (((ap_const_boolean_0 = ap_block_state5) and (icmp_ln617_fu_154_p2 = ap_const_lv1_0) and (icmp_ln559_reg_182 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state5, icmp_ln559_reg_182, icmp_ln617_fu_154_p2, ap_block_state5)
    begin
        if (((ap_const_boolean_0 = ap_block_state5) and (ap_const_logic_1 = ap_CS_fsm_state5) and ((icmp_ln617_fu_154_p2 = ap_const_lv1_1) or (icmp_ln559_reg_182 = ap_const_lv1_1)))) then 
    ...
    ap_predicate_op32_read_state5_assign_proc : process(icmp_ln559_reg_182, icmp_ln617_fu_154_p2)
    begin
                ap_predicate_op32_read_state5 <= ((icmp_ln617_fu_154_p2 = ap_const_lv1_0) and (icmp_ln559_reg_182 = ap_const_lv1_0));
    end process;


    ap_predicate_op33_write_state5_assign_proc : process(icmp_ln559_reg_182, icmp_ln617_fu_154_p2)
    begin
                ap_predicate_op33_write_state5 <= ((icmp_ln617_fu_154_p2 = ap_const_lv1_0) and (icmp_ln559_reg_182 = ap_const_lv1_0));
    end process;

    ap_ready <= internal_ap_ready;

    bestMatchStream_blk_n_assign_proc : process(bestMatchStream_empty_n, ap_CS_fsm_state5, icmp_ln559_reg_182, icmp_ln617_fu_154_p2)
    begin
        if (((icmp_ln617_fu_154_p2 = ap_const_lv1_0) and (icmp_ln559_reg_182 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    boosterStream_blk_n_assign_proc : process(boosterStream_full_n, ap_CS_fsm_state5, icmp_ln559_reg_182, icmp_ln617_fu_154_p2, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((icmp_ln617_fu_154_p2 = ap_const_lv1_0) and (icmp_ln559_reg_182 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5)))) then 
    ...
    boosterStream_din_assign_proc : process(bestMatchStream_dout, boosterStream_full_n, ap_CS_fsm_state5, ap_CS_fsm_state4, grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_boosterStream_din, grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out, ap_CS_fsm_state3, ap_predicate_op33_write_state5, ap_block_state5)
    begin
        if (((ap_const_boolean_0 = ap_block_state5) and (ap_const_logic_1 = ap_CS_fsm_state5) and (ap_predicate_op33_write_state5 = ap_const_boolean_1))) then 
            ...
            boosterStream_din <= grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            boosterStream_din <= grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_boosterStream_din;
        else 
            boosterStream_din <= grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_boosterStream_din;
    ...
    i_6_fu_160_p2 <= std_logic_vector(unsigned(i_2_fu_74) + unsigned(ap_const_lv7_1));
    icmp_ln559_fu_116_p2 <= "1" when (input_size_dout = ap_const_lv32_0) else "0";
    icmp_ln617_fu_154_p2 <= "1" when (i_2_fu_74 = ap_const_lv7_40) else "0";
    ...
    internal_ap_ready_assign_proc : process(ap_CS_fsm_state5, icmp_ln559_reg_182, icmp_ln617_fu_154_p2, ap_block_state5)
    begin
        if (((ap_const_boolean_0 = ap_block_state5) and (ap_const_logic_1 = ap_CS_fsm_state5) and ((icmp_ln617_fu_154_p2 = ap_const_lv1_1) or (icmp_ln559_reg_182 = ap_const_lv1_1)))) then 
