...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state10) & (1'b0 == ap_block_state10) & ((icmp_ln355_fu_216_p2 == 1'd1) | (icmp_ln315_reg_301 == 1'd1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln315_fu_156_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        i_6_fu_104 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state10) & (1'b0 == ap_block_state10) & (icmp_ln355_fu_216_p2 == 1'd0) & (icmp_ln315_reg_301 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) & (1'b0 == ap_block_state10) & ((icmp_ln355_fu_216_p2 == 1'd1) | (icmp_ln315_reg_301 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln355_fu_216_p2 == 1'd0) & (icmp_ln315_reg_301 == 1'd0))) begin
...
assign add_ln355_fu_222_p2 = (i_6_fu_104 + 3'd1);
...
always @ (*) begin
    ap_predicate_op53_write_state10 = ((icmp_ln355_fu_216_p2 == 1'd0) & (icmp_ln315_reg_301 == 1'd0));
end
...
assign icmp_ln355_fu_216_p2 = ((i_6_fu_104 == 3'd6) ? 1'b1 : 1'b0);
