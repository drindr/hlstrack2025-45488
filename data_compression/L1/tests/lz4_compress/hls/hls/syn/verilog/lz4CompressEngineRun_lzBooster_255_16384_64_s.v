...
reg   [0:0] icmp_ln559_reg_182;
wire   [0:0] icmp_ln617_fu_154_p2;
...
wire   [31:0] grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out;
wire    grp_lzBooster_255_16384_64_Pipeline_lz_booster_fu_106_outValue_04_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b0 == ap_block_state5) & (1'b1 == ap_CS_fsm_state5) & ((icmp_ln617_fu_154_p2 == 1'd1) | (icmp_ln559_reg_182 == 1'd1)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln559_fu_116_p2 == 1'd0))) begin
        i_2_fu_74 <= 7'd0;
    end else if (((1'b0 == ap_block_state5) & (icmp_ln617_fu_154_p2 == 1'd0) & (icmp_ln559_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state5) & (1'b1 == ap_CS_fsm_state5) & ((icmp_ln617_fu_154_p2 == 1'd1) | (icmp_ln559_reg_182 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln617_fu_154_p2 == 1'd0) & (icmp_ln559_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | ((icmp_ln617_fu_154_p2 == 1'd0) & (icmp_ln559_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln559_fu_116_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln559_fu_116_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_predicate_op32_read_state5 = ((icmp_ln617_fu_154_p2 == 1'd0) & (icmp_ln559_reg_182 == 1'd0));
end

always @ (*) begin
    ap_predicate_op33_write_state5 = ((icmp_ln617_fu_154_p2 == 1'd0) & (icmp_ln559_reg_182 == 1'd0));
end
...
assign i_6_fu_160_p2 = (i_2_fu_74 + 7'd1);

assign icmp_ln559_fu_116_p2 = ((input_size_dout == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln617_fu_154_p2 = ((i_2_fu_74 == 7'd64) ? 1'b1 : 1'b0);
