...
wire   [7:0] outValue_13_fu_371_p3;
wire   [7:0] outValue_11_fu_446_p1;
wire   [7:0] outValue_9_fu_517_p3;
...
wire   [15:0] match_length_12_fu_385_p3;
wire   [15:0] match_length_10_fu_750_p3;
...
wire   [15:0] match_length_11_fu_379_p2;
...
wire   [0:0] icmp_ln157_6_fu_603_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((1'b1 == ap_condition_659)) begin
            ...
            ap_phi_reg_pp0_iter2_outValue_5_reg_232 <= outValue_13_fu_371_p3;
            ...
            ap_phi_reg_pp0_iter2_outValue_5_reg_232 <= outValue_11_fu_446_p1;
            ...
            ap_phi_reg_pp0_iter2_outValue_5_reg_232 <= outValue_9_fu_517_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            match_length_fu_140 <= match_length_10_fu_750_p3;
        end else if ((1'b1 == ap_condition_672)) begin
            match_length_fu_140 <= match_length_12_fu_385_p3;
        end
    end
end
...
assign icmp_ln157_6_fu_603_p2 = ((match_off_tmp_fu_353_p3 == 16'd777) ? 1'b1 : 1'b0);
...
assign is_special_end_fu_609_p2 = (icmp_ln157_fu_597_p2 & icmp_ln157_6_fu_603_p2);
...
assign match_length_10_fu_750_p3 = ((match_len_ge_15_fu_718_p2[0:0] == 1'b1) ? add_ln193_fu_744_p2 : 16'd0);

assign match_length_11_fu_379_p2 = ($signed(match_length_fu_140) + $signed(16'd65281));

assign match_length_12_fu_385_p3 = ((match_len_ge_255_fu_361_p2[0:0] == 1'b1) ? match_length_11_fu_379_p2 : match_length_fu_140);
...
assign outValue_11_fu_446_p1 = match_offset_plus_one_fu_128[7:0];

assign outValue_13_fu_371_p3 = ((match_len_ge_255_fu_361_p2[0:0] == 1'b1) ? 8'd255 : trunc_ln236_fu_367_p1);

assign outValue_9_fu_517_p3 = ((lit_len_ge_255_fu_507_p2[0:0] == 1'b1) ? 8'd255 : trunc_ln205_fu_513_p1);
