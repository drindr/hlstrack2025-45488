...
module AESL_autofifo_lz4Out_eos (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.lz4CompressEngineRun.autotvin_lz4Out_eos.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.lz4CompressEngineRun.autotvout_lz4Out_eos.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 1;
parameter ADDR_WIDTH = 32'd 11;
parameter DEPTH = 32'd 597;
