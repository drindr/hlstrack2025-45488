...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lz4CompressEngineRun.autotvin_inStream.dat"
         "c.lz4CompressEngineRun.autotvin_input_size.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lz4CompressEngineRun.autotvout_lz4Out.dat"
         "rtl.lz4CompressEngineRun.autotvout_lz4Out_eos.dat"
         "rtl.lz4CompressEngineRun.autotvout_lz4OutSize.dat"
         "rtl.lz4CompressEngineRun.autotvout_max_lit_limit.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
