...
module AESL_autofifo_lz4OutSize (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.lz4CompressEngineRun.autotvin_lz4OutSize.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.lz4CompressEngineRun.autotvout_lz4OutSize.dat";
