...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe /home/yxh/fpga-amd2025/data_compression/L1/tests/lz4_compress/sample.txt /home/yxh/fpga-amd2025/data_compression/L1/tests/lz4_compress/sample.txt.encoded | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lz4CompressEngineRun.autotvin.dat"
	set constFileTvOut       "lz4CompressEngineRun.autotvout.dat"
	set constFileHdlTvIn     "lz4CompressEngineRun.autohdltvin.dat"
	set constFileHdlTvOut    "lz4CompressEngineRun.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
