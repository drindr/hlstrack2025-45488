...
#pragma HLS array_partition variable = K complete
    ...
    while (!e) {
        ...
        _XF_SECURITY_PRINT("waiting for nblk\n");
        uint64_t blk_num = nblk_strm.read();
        _XF_SECURITY_PRINT("nblk %lu\n", blk_num);
...
#pragma HLS array_partition variable = blk.M complete
            _XF_SECURITY_PRINT("got blk_strm\n");
...
#pragma HLS array_partition variable = W complete
            _XF_SECURITY_PRINT("initialized W ring\n");
...
#pragma HLS unroll
            ...
            _XF_SECURITY_PRINT("W[0..16] initialized\n");
...
#pragma HLS unroll
        ...
        _XF_SECURITY_PRINT("waiting for end_nblk\n");
...
#pragma HLS RESOURCE variable = w_strm core = FIFO_LUTRAM
    ...
    sha256Digest_unroll2(nblk_strm, end_nblk_strm, blk_strm, hash_strm, end_hash_strm);
