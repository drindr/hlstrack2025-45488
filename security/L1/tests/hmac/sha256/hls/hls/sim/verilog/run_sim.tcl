...
if {[file isfile test_hmac_sha256.autotvin.dat]} {
	file delete -force test_hmac_sha256.autotvin.dat
}

if {[file isfile test_hmac_sha256.autotvout.dat]} {
	file delete -force test_hmac_sha256.autotvout.dat
}
