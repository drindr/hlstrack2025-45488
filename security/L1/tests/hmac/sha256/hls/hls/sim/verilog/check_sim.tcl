...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.test_hmac_sha256.autotvin_keyStrm.dat"
         "c.test_hmac_sha256.autotvin_msgStrm.dat"
         "c.test_hmac_sha256.autotvin_lenStrm.dat"
         "c.test_hmac_sha256.autotvin_eLenStrm.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.test_hmac_sha256.autotvout_hshStrm.dat"
         "rtl.test_hmac_sha256.autotvout_eHshStrm.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
