...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "test_hmac_sha256.autotvin.dat"
	set constFileTvOut       "test_hmac_sha256.autotvout.dat"
	set constFileHdlTvIn     "test_hmac_sha256.autohdltvin.dat"
	set constFileHdlTvOut    "test_hmac_sha256.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
