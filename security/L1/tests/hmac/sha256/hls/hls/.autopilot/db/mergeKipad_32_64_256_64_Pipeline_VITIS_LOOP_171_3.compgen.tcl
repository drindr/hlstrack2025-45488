...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mergeKipadStrm_din { O 32 vector } mergeKipadStrm_full_n { I 1 bit } mergeKipadStrm_write { O 1 bit } mergeKipadStrm_num_data_valid { I 8 vector } mergeKipadStrm_fifo_cap { I 8 vector } } \
} "
}
