set moduleName kpad_32_64_256_32_64_sha256_wrapper_Pipeline_VITIS_LOOP_120_2
set isTopModule 0
...
set cdfgNum 22
set C_modelName {kpad<32, 64, 256, 32, 64, sha256_wrapper>_Pipeline_VITIS_LOOP_120_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ keyStrm int 32 regular {fifo 0 volatile }  }
	{ k1_out int 512 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "keyStrm", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "k1_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ k1_out sc_out sc_lv 512 signal 1 } 
	{ k1_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "k1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "k1_out", "role": "default" }} , 
 	{ "name": "k1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "k1_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	k1_out { ap_vld {  { k1_out out_data 1 512 }  { k1_out_ap_vld out_vld 1 1 } } }
}
