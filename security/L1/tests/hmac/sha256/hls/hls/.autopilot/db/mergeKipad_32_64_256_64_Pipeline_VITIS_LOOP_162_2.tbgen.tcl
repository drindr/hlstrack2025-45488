set moduleName mergeKipad_32_64_256_64_Pipeline_VITIS_LOOP_162_2
set isTopModule 0
...
set cdfgNum 22
set C_modelName {mergeKipad<32, 64, 256, 64>_Pipeline_VITIS_LOOP_162_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ kipad int 512 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "kipad", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mergeKipadStrm_din sc_out sc_lv 32 signal 1 } 
	{ mergeKipadStrm_full_n sc_in sc_logic 1 signal 1 } 
	{ mergeKipadStrm_write sc_out sc_logic 1 signal 1 } 
	{ mergeKipadStrm_num_data_valid sc_in sc_lv 32 signal 1 } 
	{ mergeKipadStrm_fifo_cap sc_in sc_lv 32 signal 1 } 
	{ kipad sc_in sc_lv 512 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "kipad", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "kipad", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	kipad { ap_none {  { kipad in_data 0 512 } } }
