set moduleName kernel_cholesky_0_Pipeline_read_matrix_rows_read_matrix_cols
set isTopModule 0
...
set cdfgNum 7
set C_modelName {kernel_cholesky_0_Pipeline_read_matrix_rows_read_matrix_cols}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict A_re { MEM_WIDTH 16 MEM_SIZE 18 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict A_im { MEM_WIDTH 16 MEM_SIZE 18 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ A_re int 16 regular {array 9 { 0 3 } 0 1 }  }
	{ A_im int 16 regular {array 9 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "A_re", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "A_im", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ matrixAStrm_dout sc_in sc_lv 32 signal 2 } 
	{ matrixAStrm_empty_n sc_in sc_logic 1 signal 2 } 
	{ matrixAStrm_read sc_out sc_logic 1 signal 2 } 
	{ A_re_address0 sc_out sc_lv 4 signal 0 } 
	{ A_re_ce0 sc_out sc_logic 1 signal 0 } 
	{ A_re_we0 sc_out sc_logic 1 signal 0 } 
	{ A_re_d0 sc_out sc_lv 16 signal 0 } 
	{ A_im_address0 sc_out sc_lv 4 signal 1 } 
	{ A_im_ce0 sc_out sc_logic 1 signal 1 } 
	{ A_im_we0 sc_out sc_logic 1 signal 1 } 
	{ A_im_d0 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_re_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "A_re", "role": "we0" }} , 
 	{ "name": "A_re_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "A_re", "role": "d0" }} , 
 	...
 	{ "name": "A_im_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "A_im", "role": "we0" }} , 
 	{ "name": "A_im_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "A_im", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	A_re { ap_memory {  { A_re_address0 mem_address 1 4 }  { A_re_ce0 mem_ce 1 1 }  { A_re_we0 mem_we 1 1 }  { A_re_d0 mem_din 1 16 } } }
	A_im { ap_memory {  { A_im_address0 mem_address 1 4 }  { A_im_ce0 mem_ce 1 1 }  { A_im_we0 mem_we 1 1 }  { A_im_d0 mem_din 1 16 } } }
