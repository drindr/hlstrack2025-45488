...
#define WRAPC_STREAM_SIZE_IN_matrixAStrm "../tv/stream_size/stream_size_in_matrixAStrm.dat"
#define WRAPC_STREAM_INGRESS_STATUS_matrixAStrm "../tv/stream_size/stream_ingress_status_matrixAStrm.dat"
#define AUTOTB_TVOUT_matrixLStrm "../tv/cdatafile/c.kernel_cholesky_0.autotvout_matrixLStrm.dat"
#define WRAPC_STREAM_SIZE_OUT_matrixLStrm "../tv/stream_size/stream_size_out_matrixLStrm.dat"
#define WRAPC_STREAM_EGRESS_STATUS_matrixLStrm "../tv/stream_size/stream_egress_status_matrixLStrm.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.kernel_cholesky_0.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_matrixLStrm "../tv/rtldatafile/rtl.kernel_cholesky_0.autotvout_matrixLStrm.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.kernel_cholesky_0.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> kernel_cholesky_0_hw_stub_wrapper(void*, void*);

extern "C"
hls::sim::Byte<4> apatb_kernel_cholesky_0_hw(void* __xlx_apatb_param_matrixAStrm, void* __xlx_apatb_param_matrixLStrm)
{
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port1 {
    ...
    .name = "matrixAStrm",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_matrixAStrm),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_matrixAStrm),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_matrixAStrm),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_matrixAStrm),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_matrixAStrm;
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port2 {
    ...
    .name = "matrixLStrm",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_matrixLStrm),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_matrixLStrm),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_matrixLStrm),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_matrixLStrm),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_matrixLStrm;
  port2.hasWrite = true;
  ...
  try {
    ...
    ap_return = kernel_cholesky_0_hw_stub_wrapper(__xlx_apatb_param_matrixAStrm, __xlx_apatb_param_matrixLStrm);
    port2.buffer();
