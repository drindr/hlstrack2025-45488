...
module AESL_autofifo_matrixLStrm (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.kernel_cholesky_0.autotvin_matrixLStrm.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.kernel_cholesky_0.autotvout_matrixLStrm.dat";
