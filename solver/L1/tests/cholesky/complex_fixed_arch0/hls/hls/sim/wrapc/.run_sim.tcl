...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kernel_cholesky_0.autotvin.dat"
	set constFileTvOut       "kernel_cholesky_0.autotvout.dat"
	set constFileHdlTvIn     "kernel_cholesky_0.autohdltvin.dat"
	set constFileHdlTvOut    "kernel_cholesky_0.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
