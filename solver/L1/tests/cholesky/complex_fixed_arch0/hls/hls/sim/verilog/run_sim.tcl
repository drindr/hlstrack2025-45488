...
if {[file isfile kernel_cholesky_0.autotvin.dat]} {
	file delete -force kernel_cholesky_0.autotvin.dat
}

if {[file isfile kernel_cholesky_0.autotvout.dat]} {
	file delete -force kernel_cholesky_0.autotvout.dat
}
